...
const STRINGS: Record<string, Dict> = {
  en: {
    ...
    status_pick_icon: "Icon", status_pick_color: "Color", status_color_none: "No color",
    ...
    wn_kanban_t: "Kanban board", wn_kanban_d: "Switch any project or label between a list and a board, and drag cards across status columns.",
    wn_status_t: "Custom statuses", wn_status_d: "Create your own workflow columns — add, rename, reorder, with icon and color — in the new Statuses tab.",
    wn_doing_t: "“In progress” status", wn_doing_d: "Now shown as a half-filled checkbox and settable via right-click or long-press.",
    wn_sort_t: "Sort the sidebar", wn_sort_d: "Order projects, areas and labels manually, by name, or by task count.",
    ...
    nav_filters: "Filters", filter_add: "New filter", sec_tasks: "Tasks",
  ...
  de: {
    ...
    status_pick_icon: "Icon", status_pick_color: "Farbe", status_color_none: "Keine Farbe",
    ...
    wn_kanban_t: "Kanban-Board", wn_kanban_d: "Jedes Projekt oder Label zwischen Liste und Board umschalten und Karten über Status-Spalten ziehen.",
    wn_status_t: "Eigene Status", wn_status_d: "Eigene Workflow-Spalten anlegen – hinzufügen, umbenennen, sortieren, mit Icon und Farbe – im neuen Tab „Status“.",
    wn_doing_t: "Status „In Arbeit“", wn_doing_d: "Wird jetzt als halb gefüllte Checkbox angezeigt und per Rechtsklick/Long-Press gesetzt.",
    wn_sort_t: "Seitenleiste sortieren", wn_sort_d: "Projekte, Bereiche und Labels manuell, nach Name oder nach Aufgabenzahl ordnen.",
    ...
    nav_filters: "Filter", filter_add: "Neuer Filter", sec_tasks: "Aufgaben",
