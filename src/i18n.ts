...
const STRINGS: Record<string, Dict> = {
  en: {
    ...
    wn_filters_t: "Filters & saved views", wn_filters_d: "Build faceted filters (time, priority, labels, lists, search) and save them as their own pages in the sidebar.",
    wn_display_t: "Per-page display", wn_display_d: "A “Display” button on every page: switch list/board, show completed, sort and group — remembered per page.",
    wn_colors_t: "Colored lists & filters", wn_colors_d: "Give projects, areas, labels and filters a color — from a curated palette or a custom color.",
    wn_new_t: "New create dialog", wn_new_d: "Create projects, areas and labels with a name and color right from the sidebar “+”.",
  ...
  de: {
    ...
    wn_filters_t: "Filter & gespeicherte Ansichten", wn_filters_d: "Facettierte Filter (Zeitraum, Priorität, Labels, Listen, Suche) bauen und als eigene Seiten in der Seitenleiste speichern.",
    wn_display_t: "Anzeige pro Seite", wn_display_d: "Ein „Anzeige“-Knopf auf jeder Seite: Liste/Board, Erledigte, Sortieren und Gruppieren – pro Seite gemerkt.",
    wn_colors_t: "Farbige Listen & Filter", wn_colors_d: "Projekte, Bereiche, Labels und Filter einfärben – aus der Palette oder mit eigener Farbe.",
    wn_new_t: "Neuer Anlege-Dialog", wn_new_d: "Projekte, Bereiche und Labels mit Name und Farbe direkt über das „+“ in der Seitenleiste anlegen.",
